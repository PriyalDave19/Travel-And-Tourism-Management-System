...
public class ViewCustomer extends JFrame implements ActionListener{
    ...
    ViewCustomer(String username){
        ...
        //labelid.setFont(new Font("SAN_SERIF",Font.PLAIN,20));
        add(labelid);
        ...
        //labelnumber.setFont(new Font("SAN_SERIF",Font.PLAIN,20));
        add(labelnumber);        
        ...
        //labelgender.setFont(new Font("SAN_SERIF",Font.PLAIN,20));
        add(labelgender);        
        ...
        //labelcountry.setFont(new Font("SAN_SERIF",Font.PLAIN,20));
        add(labelcountry);        
