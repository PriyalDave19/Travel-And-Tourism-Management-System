...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        tfusername.setFont(new Font("SAN_SERIF",Font.BOLD,14));
        ...
        tfpassword.setFont(new Font("SAN_SERIF",Font.BOLD,14));
        ...
        password.setBounds(130, 250, 135, 30);
        password.setBackground(new Color(133,193,233));
        password.setFont(new Font("SAN_SERIF",Font.BOLD,13));
